    ...
    >
      <p className="text-sm text-muted-foreground">
        {enabled ? (
          ...
          <>
            Tidak ada rekap bulanan yang dikirim. Jadwal dan isi pesannya boleh disiapkan lebih dulu &mdash; tidak ada
      ...
      {/* Kalimat yang membedakannya dari SETIAP sakelar lain di halaman ini, dan
          yang paling menentukan keputusan orang: isinya angka, jadi tidak ada
          keputusan privasi yang harus diambil lebih dulu. */}
      <p className="mt-2 rounded-md border border-border bg-background/50 p-2 text-xs text-muted-foreground">
        Sakelar ini <span className="font-medium text-foreground">berdiri sendiri</span> dari seluruh sakelar lain di
        halaman ini. Isinya <span className="font-medium text-foreground">seluruhnya angka</span> &mdash; tidak ada nama
        pasien, nomor rekam medis, nama obat, maupun nama pemasok &mdash; jadi ia bisa dinyalakan tanpa lebih dulu
        menyalakan &ldquo;Notifikasi resep&rdquo;.
      </p>
      ...
      {enabled && !adaTujuan && (
        <p className="mt-2 rounded-md border border-warning/30 bg-warning/5 p-2 text-xs">
          ...
          rekapnya tidak sampai ke mana pun. Centang di tab Tujuan pengiriman &mdash; centang itu{' '}
