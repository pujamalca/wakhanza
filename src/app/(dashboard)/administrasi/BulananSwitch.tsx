        ...
        <div className="flex min-w-0 flex-1 items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="text-title-sm">Rekap bulanan administrasi</h3>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {enabled ? (
                ...
                <>
                  Tidak ada rekap bulanan yang dikirim. Tujuan, jadwal, dan isi pesannya boleh disiapkan lebih dulu
                  &mdash; tidak ada yang keluar sampai sakelar ini dinyalakan.
                </>
              )}
            </p>
            ...
            {!enabled && langsungBerangkat && (
              <p className="mt-2 rounded-md border border-warning/40 bg-warning/5 p-2 text-xs">
                ...
                kiriman, jadi begitu dinyalakan rekap <span className="font-medium">{langsungBerangkat}</span> akan
                langsung berangkat &mdash; tidak menunggu tanggal {tanggal} bulan depan. Itu disengaja: isinya bulan yang
                sudah tutup, jadi angkanya sama saja dikirim hari ini atau tiga minggu lagi.
              </p>
            )}

            {/* Kalimat yang membedakannya dari SETIAP tab lain di halaman ini,
                dan yang paling menentukan keputusan orang: yang ini tidak
                mengirim berkas pasien ke mana pun. */}
            <p className="mt-2 rounded-md border border-border bg-background/50 p-2 text-xs text-muted-foreground">
              ...
              &ldquo;Pengiriman surat&rdquo;. Tab lain di halaman ini mengirim{' '}
              <span className="font-medium text-foreground">berkas PDF berisi nama, umur, dan alamat pasien</span> ke
              nomor pasiennya; yang ini mengirim <span className="font-medium text-foreground">satu pesan berisi angka</span>{' '}
              ke grup staf. Tidak ada nama pasien, nomor rekam medis, nama poli, maupun diagnosa di dalamnya.
            </p>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              ...
              dan <span className="font-medium text-foreground">Kirim rekap uji</span> di bawah sebelum menunggu
              jadwalnya.
              {terakhir && (
                <>
                  {' '}
            ...
            {enabled && !adaTujuan && (
              <p className="mt-2 rounded-md border border-warning/30 bg-warning/5 p-2 text-xs">
                ...
                jadi rekapnya tidak sampai ke mana pun. Centang di daftar tujuan di bawah &mdash; centang itu{' '}
